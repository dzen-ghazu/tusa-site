...
This guide will help you navigate the TUSA website and find what you need. As a club admin, it is important for you to be familiar with **three** pages:
...
**Way 1:** Access Via User Interface (UI Navigation)

- Clicking the avatar in the top right corner

![getting-started_find-your-way-around_your_account_dashboard.png](../../media/getting-started_find-your-way-around_your_account_dashboard.png)

  
**Way 2:** Access Via Direct URL (URL Navigation)
...
If you are a member of a club, you will be able to access the club's page by:

**Way 1:** Access Via User Interface (UI Navigation)

- **From your profile page,** click the **Clubs** tab, then select the club

![getting-started_find-your-way-around_your_club_dashboard.png](../../media/getting-started_find-your-way-around_your_club_dashboard.png)

![getting-started_find-your-way-around_your_club_dashboard_2.png](../../media/getting-started_find-your-way-around_your_club_dashboard_2.png)
...
There are some tabs here worth noting:

### Club Docs (Admins Only)

**Way 1:** Access Via User Interface (UI Navigation)

- Click on the **Club Docs** Tab
- Access the sub-tabs

![getting-started_find-your-way-around_your-club-dashboard_club-docs.png](../../media/getting-started_find-your-way-around_your-club-dashboard_club-docs.png)
...
- Click on the **Club Deals** tab
- Access the sub-tabs

![getting-started_find-your-way-around_your-club-dashboard_club-deals.png](../../media/getting-started_find-your-way-around_your-club-dashboard_club-deals.png)
...
- Click on the **Resources + Forms** tab
- Access the sub-tabs

![getting-started_find-your-way-around_your-club-dashboard_resources-+-forms.png](../../media/getting-started_find-your-way-around_your-club-dashboard_resources-+-forms.png)
...
| Section | What's Here |
| ---------------------------- | ---------------------------------------------- |
| **How to** | Assistant documentation for club admins. |
...
For **Event Management**, there are **five** views:
...
![getting-started_find-your-way-around_your-club-dashboard_your-store-manager.png](../../media/getting-started_find-your-way-around_your-club-dashboard_your-store-manager.png)

![getting-started_find-your-way-around_your-club-dashboard_your-store-manager-2.png](../../media/getting-started_find-your-way-around_your-club-dashboard_your-store-manager-2.png)
...
**Contact the TUSA admin;** we will:

- Ask to be **demoted from Organiser** in the club group whose store you currently access
- Ask to be **promoted to Organiser** in the club group whose store you need
